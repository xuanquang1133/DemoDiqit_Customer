...
export default function Banner() {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-gradient-to-r from-gray-900 to-gray-800">
      {/* Main Banner Container - Full screen */}
      <div className="relative w-full h-full group">
        ...
        {/* Content Overlay - Hidden by default, reveals on hover */}
        <div className="absolute inset-0 flex items-center max-md:items-end max-md:pb-8">
          <div className="container-custom">
            <div
              key={currentIndex}
              className="max-w-lg opacity-0 group-hover:opacity-100 transition-opacity duration-500 ease-in-out"
            >
              ...
              <div className="flex flex-wrap gap-4">
                <Link
                  href="/products"
                  className="inline-flex items-center gap-2 px-6 py-3 bg-white text-black rounded-full font-semibold hover:bg-red-600 hover:text-white transition-all duration-300"
                >
                  Mua sắm ngay
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3 border-2 border-white text-white rounded-full font-semibold hover:bg-white hover:text-black transition-all duration-300"
                >
                  Xem khuyến mãi
                </Link>
              </div>

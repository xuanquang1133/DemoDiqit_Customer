    ...
    <footer className="bg-black text-white py-16">
      <div className="container-custom">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold">Intern<span className="text-red-500">Shop</span></span>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed">
              Nền tảng mua sắm trực tuyến hàng đầu Việt Nam với hàng ngàn sản phẩm chất lượng.
            </p>
          </div>
          <div>
        ...
        <div className="border-t border-gray-800 pt-8 text-center text-sm text-gray-400">
          <p>© 2026 InternShop. Tất cả quyền được bảo lưu.</p>
        </div>
      </div>
    </footer>
  );

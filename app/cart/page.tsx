    ...
    <div className="min-h-screen bg-gray-50 pt-16 md:pt-20">
      <div className="container-custom py-8">
        ...
        >
          ...
          <p className="text-gray-500 mt-2">{itemCount} {itemCount === 1 ? 'sản phẩm' : 'sản phẩm'} trong giỏ hàng</p>
        </motion.div>
              ...
              {items.map((item) => {
                ...
                return (
                  <motion.div
                    ...
                    className="bg-white rounded-2xl border border-gray-100 p-4 md:p-6 hover:shadow-lg transition-shadow"
                  >
                    <div className="flex gap-4 md:gap-6">
                      {/* Product Image */}
                      <div className="relative w-24 h-24 md:w-32 md:h-32 flex-shrink-0 bg-gray-50 rounded-xl overflow-hidden">
                        {item.thumbnail ? (
                          <Image
                            src={item.thumbnail}
                            alt={item.name}
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center justify-between">
                          <p className="text-gray-500 text-sm">Đơn giá: <span className="font-medium text-gray-900">{formattedPrice}đ</span></p>
                          <p className="font-bold text-red-600 text-lg">{formattedSubtotal}đ</p>
                        </div>
                        ...
                        <div className="flex items-center justify-between mt-4">
                          ...
                          <div className="flex items-center border-2 border-gray-100 rounded-xl overflow-hidden">
                            ...
                            <span className="w-12 h-10 flex items-center justify-center font-semibold border-x-2 border-gray-100">
                              {item.quantity}
                            </span>
                            <button
                              onClick={() => updateQuantity(item.id, item.quantity + 1)}
          ...
          <div className="lg:col-span-1">
            ...
            >
              ...
              <div className="py-6">
                <div className="flex justify-between items-center">
                  ...
                  <div className="text-right">
                    <span className="text-2xl md:text-3xl font-bold text-red-600">{formattedTotal}đ</span>
                    {subtotal() < 500000 && (
                ...
                {subtotal() < 500000 && (
                    <p className="text-sm text-gray-500 mt-3 p-3 bg-gray-50 rounded-xl">
              ...
              <button
                ...
                className="w-full py-4 bg-red-600 text-white rounded-xl font-semibold hover:bg-red-700 transition-all duration-300 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl"
              >
              ...
              <Link
                href="/products"
                className="w-full mt-4 py-3 text-center text-gray-600 hover:text-black font-medium transition-colors flex items-center justify-center gap-2"
              >
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
